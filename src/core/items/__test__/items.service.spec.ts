...
describe('ItemsService', () => {
  ...
  describe('create', () => {
    it('should create and return a new item', async () => {
      dbService.db.execute.mockResolvedValueOnce([mockItem]) // Respuesta para la inserción
  ...
  describe('update', () => {
    it('should update and return an item', async () => {
      ...
      expect(result).toEqual(
        plainToInstance(ItemResDto, { ...mockItem, name: 'Updated Laptop' }),
      )
  ...
  describe('remove', () => {
    it('should remove and return an item', async () => {
      ...
      expect(result).toEqual(
        plainToInstance(ItemResDto, { ...mockItem, active: false }),
      )
      expect(dbService.db.update).toHaveBeenCalled()
      expect(dbService.db.set).toHaveBeenCalledWith({
        active: false,
